...
// fakeRepo is an [engine.Repo] for tests: a filesystem, some facts about
// itself, and a record of what was asked of it.
//
// Extend this rather than building a real repository, so a generator is
// tested through the constructor a run calls and not only through the inner
...
var _ engine.Repo = (*fakeRepo)(nil)
